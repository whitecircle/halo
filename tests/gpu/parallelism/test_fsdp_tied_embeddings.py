...
# embedding only its own share, so the ratio drops well below 1 (measured 0.82 on this config).
# bf16 forward/backward puts the intact-tie ratio at 1.0 to a few 1e-3.
GRAD_RATIO_TOL = 5e-3
