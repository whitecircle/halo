...
# token counts and so the loss trajectory of the tests pinned on this data; the family SFT suites
# that assert ``loss_decreased`` on a real checkpoint use the flat rows.
