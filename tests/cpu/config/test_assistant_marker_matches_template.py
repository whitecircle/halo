...
Only configs pinning a repo-owned ``jinja_templates/*.jinja`` are covered — a hub-bundled template
...
def test_some_config_pins_a_repo_template():
    ...
    assert _MARKER_CONFIGS, "no example pins a jinja_templates/* chat_template — the scan is broken"
