...
8xB300. That covers the global-scope EP+ETP shape too, which EPConfig would otherwise raise on during
...
def test_ep_etp_forms_the_same_dispatch_topology_the_gate_rejects_for_bare_ep():
    ...
    Run on 8xB300 through the real trainer with the gate disabled, the two shapes still do NOT
