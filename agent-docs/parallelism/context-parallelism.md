...
every attention layer (±0.0% on Qwen3-8B, CP=2, seq 16384, 2× B200). Use Liger (default on).
...
[allowlist](index.md#supported-combinations). EP alone OOMs at long sequences (it shards experts,
