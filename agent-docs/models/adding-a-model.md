...
**7. Wire the docs.** A supported family gets `agent-docs/models/<name>.md`, a matrix row in [Supported Models](index.md), a `mkdocs.yml` nav entry, the `CLAUDE.md` model lists, and an `examples/sft/<family>/` config.
