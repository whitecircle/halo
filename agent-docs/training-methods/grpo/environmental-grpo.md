...
Skip this section for dense models and `ep1` configs. Terms: [glossary](../../reference/glossary.md#parallelism); legal combinations: [parallelism matrix](../../parallelism/index.md).
...
- [Environments](environments/index.md) — types, tools, rewards, dataset format
