...
| [Distillation](distillation/index.md) | Knowledge distillation: teacher, self, online SDPG | `scripts/training/distillation/teacher_distill.py`, `scripts/training/distillation/self_distill.py`; SDPG runs `scripts/training/online_grpo/rlvr.py` with `--use_sdpg` | [DistillationConfig](../reference/configuration-reference.md#distillationconfig) | Yes | — | Yes | Yes |
