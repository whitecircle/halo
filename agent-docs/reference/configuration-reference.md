...
- `verdict_detail` (`code_contests`, `outcome` default / `full`): `outcome` omits the expected and produced output of a wrong answer, leaving `Test i: FAIL`; stderr, crash, time-limit and output-limit diagnostics stay in both modes.
