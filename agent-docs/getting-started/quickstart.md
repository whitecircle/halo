...
| Distillation | `scripts/training/distillation/{teacher_distill,self_distill}.py` | [Distillation](../training-methods/distillation/index.md) |
...
```bash
HF_HOME=/mnt/hf HF_DATASETS_CACHE=/mnt/hf/datasets TMPDIR=/mnt/tmp HALO_DATA_ROOT=/mnt \
...
append `> /mnt/job.log 2>&1` to also capture the other ranks (e.g. a crash off rank 0).
