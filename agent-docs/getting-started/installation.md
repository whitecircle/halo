...
> [!WARNING]
> **Run inside the Docker image — the host has no usable Python environment**
>
...
| GPU | Hopper (SM90) or Blackwell (SM100/103) | The two release targets. Ampere and Ada (SM80–89) can run single-GPU LoRA/QLoRA from the Blackwell image, whose torch, FA2 and bitsandbytes carry sm_80–sm_89 kernels; DeepEP, FA3 and FA4 do not run there, and the path is not validated |
...
> [!NOTE]
> **Hopper + CUDA 13.2: split-K kernel stub**
>
