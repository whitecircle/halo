"""HF attention class name → Ulysses wrapper class, derived from the wrapper subclass tree. Imports every
family module first, so a new family registers by existing."""
