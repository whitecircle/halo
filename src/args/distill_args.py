...
class DistillScriptArguments(ConversationRenderArguments, CommonScriptArguments):
    ...
    def _validate_ranges(self) -> None:
        """An empty teacher reaches the loader as a blank model id and fails there, long after the
        run has claimed a node — and the CLI override path bypasses ``__post_init__`` entirely."""
