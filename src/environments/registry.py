...
def _without(env_config: dict, *exclude: str) -> dict:
    ...
    Used only for that case: every other factory forwards ``**env_config`` whole. Nothing is defaulted
    here, since a registry-injected value would override the environment class's own default.
    """
