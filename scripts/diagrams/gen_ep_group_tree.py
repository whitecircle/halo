...
# The only EP+TP shape ParallelismConfig accepts across NVLink domains: one global EP group spanning
# the job. Node-local EP groups under TP (ep8/tp8 here) are rejected by ``_validate_tp``.
ax.text(
    6,
    9.25,
