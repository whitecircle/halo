...
copy/slice from rank 0; Σa = chunk a summed over ranks. The panel pair-up
makes the two §9 identities visible: all-reduce is the RS+AG composition,
and all-to-all is a transpose of the rank×chunk grid.
"""
