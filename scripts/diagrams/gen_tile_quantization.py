...
no absolute number to clash with the §2 table. The tile/wave structure makes
throughput non-smooth: it ramps at small M (few tiles, so most of the 148 SMs
idle), then ripples near peak rather than following the deep sawtooth the
geometry alone predicts, since small M is occupancy-limited either way.
"""
