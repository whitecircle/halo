...
Defines M, N, K once, visually: a layer is Y = X @ W, where M is the row count
(= tokens, the knob you turn), and K, N are the weight's fixed shape. The weight
W is read from HBM regardless of M — the asymmetry the roofline rests on.
"""
