...
PEAK = 1818.0  # TFLOP/s: best dense bf16 8192^3 GEMM, unloaded B300 (arch ceiling 2464)
...
# Diagonal label rotated to the line's on-screen angle, computed after layout so the transform is
# final.
fig.canvas.draw()
