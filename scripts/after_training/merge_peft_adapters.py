...
Examples:
    ...
    # The model-loading helpers log through the accelerate logger, which raises unless the state is
    # initialized; this script is a single-process tool, so initialize it explicitly.
    PartialState()
