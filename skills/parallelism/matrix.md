...
| **EP + TP + ETP** | `ep_size>1 and tp_size>1 and expert_tp_size>1` | attention TP and expert TP cannot both shard the EP group; use EP+TP **or** (pure/EP+)ETP | `_validate_capability_matrix` + `AXIS_SET_MECHANISMS[{ep,tp,etp}]` |
