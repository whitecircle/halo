...
description: >-
  ...
  at this repo's fine-grained MoE shapes (low-precision fp8/fp4 compute, native
...
for a concrete config. **[levers.md](levers.md)** holds every figure — measured on B300, each
