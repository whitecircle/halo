...
- **It must fail when the behaviour breaks.** Mentally mutate the function (flip a sign, drop a
  ...
  `agent-docs/contributing/index.md` → "A test must not be AI-slop".)
...
## Sources of truth
`harness.md` / `matrix.md` + `agent-docs/contributing/index.md` document the conventions. The code is the
