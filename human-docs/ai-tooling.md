...
The training images come with
[Claude Code](https://github.com/anthropics/claude-code) preinstalled — the same
tooling Halo is developed with — plus skills that teach it this codebase's
configs, limits, and footguns.

The install is best-effort at build time. If the CLI is missing from your image,
...
Every skill is grounded in [`agent-docs/`](../agent-docs/index.md) ↗, the same
