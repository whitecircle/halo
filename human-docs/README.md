...
Tensor, and Expert-Tensor Parallelism, and covers pre-training through
multi-turn RL on dense models and fifteen MoE families. A HuggingFace model
goes in; a HuggingFace model comes out, loadable with plain `from_pretrained`.

These pages are short and task-first. Links marked ↗ leave this guide for
[`agent-docs/`](../agent-docs/index.md), the exhaustive reference — written
...
- [AI Tooling](ai-tooling.md) — the Claude Code install and repo-aware skills
