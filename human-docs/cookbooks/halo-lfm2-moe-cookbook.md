...
output_dir: /mnt/checkpoints/lfm2.5-8b-a1b-ultrachat-ep2
...
```bash
export LFM2_CHECKPOINT=/mnt/checkpoints/lfm2.5-8b-a1b-ultrachat-ep2
```
...
output_dir: /mnt/checkpoints/lfm2-24b-a2b-ultrachat-ep4
```
...
```bash
export LFM2_CHECKPOINT=/mnt/checkpoints/lfm2-24b-a2b-ultrachat-ep4
```
...
SGLANG_MODEL=/mnt/checkpoints/lfm2.5-8b-a1b-ultrachat-ep2 \
...
output_dir: /mnt/checkpoints/lfm2.5-8b-a1b-ultrachat-lora
```
...
VLLM_MODEL=/mnt/checkpoints/lfm2.5-8b-a1b-ultrachat-ep2 \
