...
output_dir: /mnt/checkpoints/laguna-s-2.1-ultrachat-ep4
...
output_dir: /mnt/checkpoints/laguna-xs-2.1-ultrachat
```
...
path = "/mnt/checkpoints/laguna-s-2.1-ultrachat-ep4"
...
SGLANG_MODEL=/mnt/checkpoints/laguna-s-2.1-ultrachat-ep4 \
...
output_dir: /mnt/checkpoints/laguna-s-2.1-ultrachat-lora
```
...
VLLM_MODEL=/mnt/checkpoints/laguna-s-2.1-ultrachat-ep4 \
