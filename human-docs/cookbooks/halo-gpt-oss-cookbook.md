...
test_size: 0.01
chat_template: jinja_templates/gpt-oss-multiturn.jinja
...
output_dir: /mnt/checkpoints/gpt-oss-20b-ultrachat-ep8
...
path = "/mnt/checkpoints/gpt-oss-20b-ultrachat-ep8"
...
SGLANG_MODEL=/mnt/checkpoints/gpt-oss-20b-ultrachat-ep8 \
...
output_dir: /mnt/checkpoints/gpt-oss-20b-ultrachat-lora
```
...
```bash
VLLM_MODEL=/mnt/checkpoints/gpt-oss-20b-ultrachat-ep8 \
