<p align="center">
    <img src="https://whitecircle.com/favicon.ico?favicon.1gqxp2-fbpeoq.ico" height="88">
...
Halo is an open-source framework built by [White Circle](https://whitecircle.com) for training large language and multimodal models. It supports pre-training, SFT, preference optimization, multi-turn RL, and much more.
...
- **RL inference runs separately from training.** vLLM or SGLang servers handle generation, while training workers synchronize weights to them over NCCL. This keeps the rollout runtime out of the training process.
...
halo launch sft examples/sft/gptoss/gptoss-20b-multinode-ep.yaml \
    -n 8 -- --expert_parallel_size=8
...
The training images include Claude Code, plus repo-specific skills for [launching jobs](skills/launch),
...
- **[`human-docs/`](human-docs/README.md)** — shorter, task-oriented guides for installing, configuring,
  and running Halo.
- **[`agent-docs/`](agent-docs/index.md)** — the full technical reference about model integrations,
...
[Models](agent-docs/models/index.md) · [Adding a Model](agent-docs/models/adding-a-model.md) ·
