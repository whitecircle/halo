...
[`agent-docs/contributing/index.md`](agent-docs/contributing/index.md).
...
- **Tests ship with behavior — and must not be slop.** A test must *fail when the behavior breaks*; no
  ...
  See the anti-slop test guide in [`agent-docs/contributing/index.md`](agent-docs/contributing/index.md).
